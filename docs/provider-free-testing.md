...
When this guide says “current XRTM release,” it means the published `xrtm`
package version for the product-first workflow. `xrtm-forecast` versions
independently; see the governance
