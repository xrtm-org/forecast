...
class AuditHasher:
    ...
    def calculate_hash(data: Dict[str, Any]) -> str:
        r"""Calculates a deterministic SHA-256 hash of a dictionary."""
    ...
    def sign_log(log_dict: Dict[str, Any]) -> str:
        r"""Generates a signature for the given log dictionary."""
    ...
    def verify_log(log_dict: Dict[str, Any]) -> bool:
        r"""Verifies that the signature matches content."""
