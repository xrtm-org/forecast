...
from xrtm.forecast.kit.agents import Agent, GraphAgent, LLMAgent
...
def create_debate_graph(
    ...
    orchestrator: Orchestrator[BaseGraphState] = Orchestrator.create_standard(max_cycles=max_rounds * 3 + 2)
